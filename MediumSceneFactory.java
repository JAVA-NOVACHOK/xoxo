...
import xoxo.SmallSceneFactory;


public class MediumSceneFactory implements SceneFactory{
    
    private GridPane create() {
        GridPane pane = null;
        try {            
             pane = FXMLLoader.load(getClass().getResource("FXMLDocuments/Medium_Size.fxml"));
